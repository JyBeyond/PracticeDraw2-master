...
public class Practice12PathEffectView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 第三处：DashPathEffect
        DashPathEffect dashPathEffect = new DashPathEffect(new float[]{ 20, 10 }, 20);
        ...
        ComposePathEffect composePathEffect=new ComposePathEffect(pathDashPathEffect,dashPathEffect);
